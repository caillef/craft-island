...
void ADojoHelpers::CallCraftIslandPocketActionsPlace(const FAccount& account, long x, long y, long z, int item_id) {
    TArray<FString> args;
    args.Append(ConvertToFeltHexa<long>(x, \
                                 "u64"));
    args.Append(ConvertToFeltHexa<long>(y, \
                                 "u64"));
    args.Append(ConvertToFeltHexa<long>(z, \
                                 "u64"));
...
void ADojoHelpers::CallControllerCraftIslandPocketActionsPlace(const FControllerAccount& \
                     account, long x, long y, long z, int item_id) {
    TArray<FString> args;
    args.Append(ConvertToFeltHexa<long>(x, \
                                 "u64"));
    args.Append(ConvertToFeltHexa<long>(y, \
...
void ADojoHelpers::CallCraftIslandPocketActionsHitBlock(const FAccount& account, long x, long y, long z, int hp) {
    TArray<FString> args;
    args.Append(ConvertToFeltHexa<long>(x, \
                                 "u64"));
    args.Append(ConvertToFeltHexa<long>(y, \
...
void ADojoHelpers::CallControllerCraftIslandPocketActionsHitBlock(const FControllerAccount& \
                     account, long x, long y, long z, int hp) {
    TArray<FString> args;
    args.Append(ConvertToFeltHexa<long>(x, \
                                 "u64"));
    args.Append(ConvertToFeltHexa<long>(y, \
...
void ADojoHelpers::CallCraftIslandPocketActionsUseItem(const FAccount& account, long x, long y, long z) {
    TArray<FString> args;
    args.Append(ConvertToFeltHexa<long>(x, \
                                 "u64"));
    args.Append(ConvertToFeltHexa<long>(y, \
