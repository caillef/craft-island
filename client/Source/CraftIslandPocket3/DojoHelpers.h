...
// Model definition for `craft_island_pocket::models::GatherableResource` model
UCLASS(BlueprintType)
...
// Model definition for `craft_island_pocket::models::Inventory` model
UCLASS(BlueprintType)
...
// Model definition for `craft_island_pocket::models::IslandChunk` model
UCLASS(BlueprintType)
...
// Model definition for `craft_island_pocket::models::PlayerData` model
UCLASS(BlueprintType)
...
// Model definition for `craft_island_pocket::models::PlayerStats` model
UCLASS(BlueprintType)
...
//    void ControllerAccountCallbackUrl(const char *url);

    static void ControllerCallbackProxy(ControllerAccount *account);

//    static void ControllerCallbackUrlProxy(const char *url);
...
//    UFUNCTION(BlueprintCallable)
//    void ControllerGetAccountOrConnectMobile(const FString& rpc_url, const FString& chain_id);
//
//    DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnDojoControllerURL,
//                                                FString,
//                                                Url);

//    UPROPERTY(BlueprintAssignable)
//    FOnDojoControllerURL FOnDojoControllerURL;
    ...
    UFUNCTION(BlueprintCallable, Category = "Calls")
    void CallCraftIslandPocketActionsPlace(const FAccount& account, int64 x, int64 y, int64 z, int resource_id);

    UFUNCTION(BlueprintCallable, Category = "Controller Calls")
    void CallControllerCraftIslandPocketActionsPlace(const FControllerAccount& account, int64 x, int64 y, int64 z, int resource_id);
