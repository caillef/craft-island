...
enum class E_Item : uint8
{
    ...
    Bowl UMETA(DisplayName = "Bowl"),
    Chest UMETA(DisplayName = "Chest"),
    WoodenChair UMETA(DisplayName = "Wooden Chair"),
    WoodenTable UMETA(DisplayName = "Wooden Table"),
    WoodenBench UMETA(DisplayName = "Wooden Bench"),
    WorkshopPattern UMETA(DisplayName = "Workshop Pattern"),
    WellPattern UMETA(DisplayName = "Well Pattern"),
